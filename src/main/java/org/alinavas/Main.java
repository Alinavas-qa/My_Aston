...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(printSign(3));
        System.out.println(printSign(-1));
        System.out.println(printSign(0));
        System.out.println(printBoolean(-1));
        System.out.println(printBoolean(1));
        System.out.println(printString("Приветики-пистолетики", 2));
        System.out.println(yearBoolean(800));
        System.out.println(yearBoolean(4));
        System.out.println(yearBoolean(100));
    }
    /*
    ...
    */
    ...
    public static String printSign(int a) {
        if (a >= 0)
    ...
    public static int printString(String str, int n) {
        for (int i = 1; i <= n; i++) {
